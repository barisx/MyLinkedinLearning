...
stripe.api_key = 'sk_test_51IYFfcLlEWCSgREzmi5GUWZhBWxDLrDvjdH5FnqjmLBRgTb7pL6eO0jXs6FOQV0YoQ8RUZDW1gl0Uqg8NPJyVVtf00Y6AREABb'
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        plan = 'price_1IYFilLlEWCSgREzGU0sfACN'
        if request.POST['plan'] == 'yearly':
            plan = 'price_1IYFimLlEWCSgREzGLxm9kA4'
        ...
        return render(request, 'plans/checkout.html',
            {'plan':plan, 'coupon': coupon, 'price': price,
            'og_dollar':og_dollar, 'coupon': coupon_dollar, 'final_dollar':final_dollar})

class Subject(object):
	...
	def __init__(self):
		self._observers = []  # This where references to all the observers are being kept
							 # Note that this is a one to many relationship: there will be one subject to be observerd by multiple _observer
...
class Core(Subject): # Inherits from te Subject class

	def __init__(self, name=""):
		Subject.__init__(self)
		self._name = name  #Set the name of the core
		self._temp = 0  #Initialize the temoerature of the core
